...
export default function NavBar() {
  ...
  return (
    <header className="w-full bg-white border-slate-200 px-4 sm:px-6 lg:px-12 py-3.5 border-b sticky top-0 z-50">
...
//   return (
//     <header className="w-full bg-white border-slate-200 px-6 lg:px-12 py-3.5 border-b sticky top-0 z-100">
//       <div className="max-w-7xl mx-auto flex items-center justify-between">
//         {/* 1. LOGO SECTION */}
//         <div className="flex items-center">
//           <div className="w-12 h-12 rounded-full border-2 border-[#ff6200]/30 p-0.5 flex items-center justify-center bg-white shadow-sm overflow-hidden">
