...
const Mvc =[
  {
    ...
    description:' Our mission is to enhance the Abia green Shuttle experience by providing commuters with real-time transit information, seamless transport card management, and accessible digital services that make every journey simpler, more predictable, and stress-free. ',
  },
  {
    id: 2,
    title: "Vission",
    icon: <BsEye />,
    description: 'To create a smarter, more connected public transportation ecosystem where every commuter in Abia state can travel with confidence, convenience, and real-time access to essential transport services.',
...
function AboutUs() {
  return (
    ...
    >
      ...
      <div className='text-center py-40 px-6 sm:px-10 md:px20 lg:px-50  tracking-wide text-[#ffffff] '>
        <h1 className='tracking-wide text-3xl sm:text-4xl md:text-5xl font-bold mb-5 lg:pl-50] shadow-2xl'>ABOUT US</h1>

        <p className='lg:pl-50 max-w-4xl md:text-lg mx-auto text-sm sm:text-base shadow-md'>The Abia Green Shuttle is a state-sponsored electric vehicle (EV) public transport system  introduced by the Abia State Government to provide affordable, eco-friendly commuting </p>
        
      </div>
    </div>

    <div className='flex flex-col mt-20 mx-6 mb-4 md:flex-row  gap-8'>
      ...
      <div className='ml-0 md:ml-10 w-full md:w-1/2'>
        ...
        <h1 className='text-3xl font-bold tracking-wide pt-3 pb-7'>Our Story</h1>

        <p className='tracking-wide pb-7'>ABIA Green Shuttle Was created to modernize public transportation by combining clean electric buses with digital technology.  </p>

        <p className='pb-10'>Our platform allows passengers to easily track buses pay digitally, plan routes, and enjoy a seamless commuting experience</p>

        <p>we believe transportation should be smart, affordable and accessible to everyone</p>

      </div>
    </div>

    <section className='px-5 md:px-10 py-10 bg-orange-100'>
          ...
          className='bg-[#ffffff] rounded-3xl shadow-md p-8 min-h-80'>
            ...
            <div className='flex justify-between items-center mb-8'>
              ...
              {/* mission and Vission */}
                ...
                {Mvc.description && (
                  <p className=' text-gray-700 text-lg leading-relaxed'>{Mvc.description} </p>
                )}
    ...
    <section className='bg-white py-12 px-5'>
      <div className='text-center mb-8'>
        <h4 className='rounded-full text-orange-500 bg-orange-200 w-30 mx-auto'>why choose us</h4>
        <h1 className='text-3xl md:text-4xl font-bold text-gray-900'>Why Thousands choose</h1>
        <h2 className='text-2xl md:text-3xl font-bold text-orange-600'>ABIA Green Shuttle</h2>
      </div>
    ...
    <section className='bg-[#000000] py-10 px-5 text-white'>
      <div className='text-center'>
        ...
        <h2 className='text-3xl md:text-4xl font-bold'>
          Making Transportation Better Everyday</h2>
      </div>
      ...
      <div className='grid grid-cols-2 md:grid-cols-4 max-w-6xl gap-10 mt-10 mx-auto text-center'>
        {impacts.map ((impact) =>(
          ...
          className=''>
            ...
            <h2 className='text-2xl font-bold text-[#fd550a]'>{impact.number} </h2>
    ...
    <section className='bg-[#fff7f4] px-5 py-12'>
      <div className='text-center mb-10 '>
        <h3 className='text-[#fd550a] font-medium'>What Our Riders Say</h3>
        <p className='text-[#000000] text-3xl font-bold'>Loved By Thousands of Commuters</p>
      </div>
