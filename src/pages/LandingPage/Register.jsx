...
function Register() {
  ...
  return (
    <section className="w-5/6  mx-auto bg-gray-50 shadow-2xl mb-3">
      <div className="flex flex-col items-center mt-15 mb-10">
        <button
          className="border py-2 px-7 rounded-xl bg-[#ff6200] text-white"
          onClick={() => navigate("/")}
        >
          LOGO
        </button>
      ...
      <div className=" mt-1.5">
        <h1 className="md:text-center font-bold md:text-2xl text-3xl">
          Create Your Account
        </h1>
      ...
      <div className="w-5/6 mx-auto">
        <form action="" onSubmit={handleSubmit(SubmitFn)}>
          ...
          <div className="flex flex-col md:flex-row justify-between gap-3 mb-3">
            <div className="w-full md:w-[50%] ">
              ...
              <input
                ...
                className="border border-gray-400 rounded-xl py-3 w-full"
                 {...register("dateOfBirth")}
              />
             
              {errors.dateOfBirth && (
                <p className="text-red-700 text-sm">{errors.dateOfBirth.message} </p>
              )}
            </div>
            <div className="w-full md:w-[50%]">
              <div>
          ...
          <button
            type="submit"
            className="border border-gray-400 shadow w-full p-2 rounded-xl mb-3 bg-[#ff6200] text-white"
          >
            Create Account
          </button>
        </form>
